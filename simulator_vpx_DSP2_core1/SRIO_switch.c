...
int rio_discovery_fabric(Uint32 uiLocalPort)
{
	 ...
	 ********************************************/
	//++++ edit by LRH ++++:
	uiMaintenanceValue = DEVICE_ID3_16BIT;
